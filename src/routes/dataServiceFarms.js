      ...
      if (req.timedout) { 
        next (); 
          ...
          for(let i=0; i<charaterizationFarmList.length; i++){
              ...
              cp.cell(2+i, 61).string(charaterizationFarmList[i].purlieuSouth)
              cp.cell(2+i, 62).string(charaterizationFarmList[i].purlieuEast)
              cp.cell(2+i, 63).string(charaterizationFarmList[i].purlieuWest)
              ...
              cp.cell(2+i, 110).string(charaterizationFarmList[i].cantPlants2)
              ...
              cp.cell(2+i, 124).string(charaterizationFarmList[i].cantPlants3)
              ...
              cp.cell(2+i, 138).string(charaterizationFarmList[i].cantAnimals)
              cp.cell(2+i, 139).string(charaterizationFarmList[i].numberPlaces)
              cp.cell(2+i, 140).string(charaterizationFarmList[i].ageAverageAnimals)
              cp.cell(2+i, 141).string(charaterizationFarmList[i].ageCrop4)
              cp.cell(2+i, 142).string(charaterizationFarmList[i].cantKgProducedByYear4)
              cp.cell(2+i, 143).string(charaterizationFarmList[i].cropStatus4)
              cp.cell(2+i, 144).string(charaterizationFarmList[i].aproxArea4)
              ws.cell(2+i, 145).string(arrayCoordenates4[0])
              cp.cell(2+i, 146).string(arrayCoordenates4[1])
              cp.cell(2+i, 147).string(charaterizationFarmList[i].nutritionType)
              cp.cell(2+i, 148).string(charaterizationFarmList[i].promKgComercializateValu4)
              cp.cell(2+i, 149).string(charaterizationFarmList[i].nombreLineaProductiva5)
